...
export const RegistrationInviteCodeScalarFieldEnumSchema = z.enum(['id','code','expiresAt','revoked','usageCount','lastUsedAt','createdAt','createdById']);

export const OrganizationJoinCodeScalarFieldEnumSchema = z.enum(['id','organizationId','code','expiresAt','revoked','usageCount','lastUsedAt','createdAt','createdById']);
...
export const InterviewRoomScalarFieldEnumSchema = z.enum(['id','organizationId','createdById','title','intervieweeName','status','sourceLang','targetLang','translationEngine','settings','createdAt','updatedAt']);

export const InterviewMessageScalarFieldEnumSchema = z.enum(['id','interviewId','authorId','role','content','metadata','createdAt']);

export const InterviewNotesScalarFieldEnumSchema = z.enum(['id','interviewId','content','updatedById','updatedAt','createdAt']);

export const InterviewTranscriptSegmentScalarFieldEnumSchema = z.enum(['id','interviewId','segmentKey','speaker','startMs','endMs','text','translation','language','sourceLang','targetLang','translationEngine','isFinal','metadata','createdAt','updatedAt']);
...
/////////////////////////////////////////
// REGISTRATION INVITE CODE SCHEMA
/////////////////////////////////////////
...
export type RegistrationInviteCode = z.infer<typeof RegistrationInviteCodeSchema>

/////////////////////////////////////////
// ORGANIZATION JOIN CODE SCHEMA
/////////////////////////////////////////

export const OrganizationJoinCodeSchema = z.object({
  id: z.string().cuid(),
  organizationId: z.string(),
  code: z.string(),
  expiresAt: z.coerce.date(),
...
export type OrganizationJoinCode = z.infer<typeof OrganizationJoinCodeSchema>
...
export const InterviewRoomSchema = z.object({
  ...
  sourceLang: z.string(),
  targetLang: z.string(),
  translationEngine: z.string().nullable(),
...
/////////////////////////////////////////
// INTERVIEW TRANSCRIPT SEGMENT SCHEMA
/////////////////////////////////////////
...
export type InterviewTranscriptSegment = z.infer<typeof InterviewTranscriptSegmentSchema>
