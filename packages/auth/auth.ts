...
import { migratedPassword } from "./password";
...
export const auth = betterAuth({
	...
	plugins: [
		...
		organization({
			roles: {
				// The organization plugin merges its default roles, so explicitly
				// overwrite admin to keep organization membership owner/member-only.
				admin: undefined,
			},
