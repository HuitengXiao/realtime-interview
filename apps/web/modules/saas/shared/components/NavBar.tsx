...
export function NavBar({ expanded = true }: { expanded?: boolean }) {
			...
			? [
					{
						...
						icon: Mic2Icon,
						isActive: pathname.startsWith(`${basePath}/interviews`),
					},
				]
			: []),
		...(activeOrganization
	...
	return (
		<nav
			...
			className={cn("w-full border-b", {
				"w-full md:fixed md:top-0 md:left-0 md:h-full md:w-[280px] md:border-r md:border-b-0 md:transition-transform md:duration-200":
					useSidebarLayout,
